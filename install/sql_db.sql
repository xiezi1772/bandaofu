...
(3, '又一个使用易企CMS的网站开通了', 2, 1, '又一个使用易企CMS的网站开通了', '又一个使用易企CMS的网站开通了', '又一个使用易企CMS的网站开通了', 'yiqi-starter', '<p>又一个使用<a href="http://www.yiqicms.com">易企CMS</a>的网站开通了.</p><p><a href="http://www.yiqicms.com">易企CMS</a>是为国内用户专门定制的一套企业建站系统,操作简单,管理方便,对搜索引擎更友好,使您网站排名变得更轻松</p>', now(), now(), 'article.tpl', 1, 'ok'),
...
(45, '轮播图设置', '轮播图设置', 'member', '23', 'lunbo.php', '0', 'ok'),
(46, '附件', '附件', 'attach', '20', 'attach.php', '0', 'ok');
#<--break-->
INSERT INTO `yiqi_settings` (`sid`, `varname`, `description`, `value`) VALUES
(1, 'sitename', '网站名称', '易企内容管理系统'),
(3, 'sitetemplets', '网站模板', '3'),
(4, 'siteicp', '网站备案号码', '-'),
(5, 'sitestat', '网站统计代码', '-'),
(6, 'sitecopy', '网站版权信息', '© 2009-2015 <a href="http://www.yiqicms.com">易企科技</a>'),
...
(3, '搜外专供', 'seowhy', '../templets/seowhy/preview.gif', 'SEOWHY-XIAOLIANG', 'FOR IE8+<br>Copyright 2015 seowhy.com all rights reserved.', '2015-08-06 00:00:00', 'ok');