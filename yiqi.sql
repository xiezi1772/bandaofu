...
-- ----------------------------
INSERT INTO `yiqi_article` VALUES ('1', '公司简介', '1', '1', '山东青岛斑道夫公司简介', '公司简介', '青岛平度斑道夫祛斑公司成立于2015年，斑道夫祛斑是青岛平度斑道夫祛斑的直属机构。斑道夫祛斑经过三年来的发展，目前全国范围内已有20多家。', 'profile', '<h2>【公司介绍】</h2><p>青岛平度斑道夫祛斑公司成立于2015年，斑道夫祛斑是<span style=\"white-space: normal;\">青岛平度斑道夫祛斑</span>的直属机构。斑道夫祛斑经过三年来的发展，目前全国范围内已有20多家。</p><p>斑道夫祛斑， 因其专业性、高效性、安全性祛斑，受到广大爱美女性的信赖。斑道夫祛斑利用色素提取棒提取雀斑色素，再敷五天中药膜，五天揭膜修复后，从而达到祛除雀斑的效果。由于该技术的特殊和专业性，在祛斑过程中对表皮无损害，针对的只是病变的基因，度过保养期后即无需使用产品维护效果。</p><h2>【公司理念】</h2><p>自信：自信给人以力量，给人以快乐，是最宝贵的源动力。这支凝聚一心的团队，正在用自信的脚步，走出灿烂的未来。</p><p>坚持：创业之路注定风雨兼程，我们绝不因任何艰难险阻而止步不前，深植于心的梦想，不会因失败挫折而消逝，只会因坚持不懈的斗志而散发万丈光芒。</p><p>创新：创新是每个团队必须永恒不变的定律，不断改变自己的灵魂才能做到真正的打造实体转网络第一团队的品牌。\n			执行力：执行力是灵魂，高质高效的指导思想是我们快速壮大之根本。面瞬息万变的局势，我们将以更快的反应速度，更强的执行力，拥抱变化，把握未来。</p><p>&quot;自信、坚持、创新、执行力&quot;的团队理念是公司稳步发展的基石。公司崇尚学习，乐于分享，培训机制完善，是一支学习型，培训机制完善，拥有阵容强大的内部特训团队，也拥有专业化的产品研发团队。团队成员在这里不断的学习补充，不懈的追求得到了提升，从而在瞬息万变的市场环境下，多一份明朗，少一些迷茫！</p>', '2017-12-09 08:54:54', '2017-12-11 13:06:38', 'profile.tpl', '16', 'ok', '');
INSERT INTO `yiqi_article` VALUES ('2', '业务介绍', '1', '1', '山东青岛斑道夫业务介绍', '业务介绍', '公司独创“1+1”互动教学模式，让祛斑老师与学员、学员与学员之间，能够相辅相成、相互促进，师生互动、生生互动，以产生教学共振，达到提高学习效果', 'business', '<h1>【业务介绍】</h1><p>公司独创“1+1”互动教学模式，让祛斑老师与学员、学员与学员之间，能够相辅相成、相互促进，师生互动、生生互动，以产生教学共振，达到提高学习效果。每月数十期的精品小班授课，学期为5天，全程辅导学员的学习，终身免费来公司进修，全天24小时客服咨询为您答疑解惑，是学员选择斑道夫之后的有力保障！</p><p>同时，斑道夫祛斑历经三年来，也因其专业性、高效性、安全性祛斑，受到广大爱美女性的信赖。斑道夫祛斑利用色素提取棒提取雀斑色素，再敷五天中药膜，五天揭膜修复后，从而达到祛除雀斑的效果。由于该技术的特殊和专业性，在祛斑过程中对表皮无损害，针对的只是病变的基因，度过保养期后即无需使用产品维护效果。</p>', '2017-12-09 08:54:54', '2017-12-11 13:10:08', 'business.tpl', '6', 'ok', '');
INSERT INTO `yiqi_article` VALUES ('4', '联系我们', '1', '1', '联系我们', '联系我们', '联系我们', 'contact', '<p>-</p>', '2017-12-11 13:29:45', '2017-12-11 13:30:43', 'contact.tpl', '3', 'ok', '');
INSERT INTO `yiqi_article` VALUES ('5', '斑道夫操作简单易学保障', '2', '1', '斑道夫操作', '斑道夫操作', '斑道夫操作', '20171211160919', '<p>斑道夫操作简单易学保障100/五天学会,终生免费复修。2担心加盟和代理太贵。</p><p><br/></p><p>斑道夫总部不仅免费培训祛斑。还有公司其它项目可以学。全国低价招商代理。确保同一地区仅此一家。3担心没钱创业。总部回复。全套产品公司送。</p><p><br/></p><p>全套设备公司送。一次拓客。收回成本。5担心没有客源中国十个人九个有斑。一个没有还有痣6担心效果不好斑道夫总部回复斑道夫采用DNA色素低温提取转移技术原理利用德国最新进口技术点斑魔笔。</p><p><br/></p><p>通过196超低温提取。斑点色素即可显现脸上。敷上中药面膜5天后斑点全无阻断斑点再生。达到根除的目地</p>', '2017-12-11 16:08:20', '2017-12-11 16:09:19', 'article.tpl', '38', 'ok', null);
...
-- ----------------------------
INSERT INTO `yiqi_navigate` VALUES ('1', '顶部导航', '网站首页', '{siteurl}/', '0', 'ok', '0');
INSERT INTO `yiqi_navigate` VALUES ('2', '顶部导航', '公司介绍', '{siteurl}/article.php?name=about', '1', 'ok', '0');
INSERT INTO `yiqi_navigate` VALUES ('3', '顶部导航', '联系我们', '{siteurl}/article.php?name=contact', '2', 'ok', '0');
INSERT INTO `yiqi_navigate` VALUES ('4', '顶部导航', '在线留言', '{siteurl}/comment.php', '3', 'ok', '0');
INSERT INTO `yiqi_navigate` VALUES ('5', '次导航', '网站首页', '{siteurl}/', '0', 'ok', '0');
