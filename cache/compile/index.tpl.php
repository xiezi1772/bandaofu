...
/images/banner.jpg" alt="五天天揭膜祛斑"></li>
		<li><img src="<?php echo $this->_tpl_vars['siteurl']; ?>
/templets/<?php echo $this->_tpl_vars['templets']->directory; ?>
/images/banner1.jpg" alt="祛斑加盟"></li>
		<li><img src="<?php echo $this->_tpl_vars['siteurl']; ?>
/templets/<?php echo $this->_tpl_vars['templets']->directory; ?>
/images/banner2.jpg" alt="图2展示"></li>
		<li><img src="<?php echo $this->_tpl_vars['siteurl']; ?>
/templets/<?php echo $this->_tpl_vars['templets']->directory; ?>
...
/images/banner32.jpg" alt="教学、技术、公司、营销、售后等保障"></li>
		<li><img src="<?php echo $this->_tpl_vars['siteurl']; ?>
/templets/<?php echo $this->_tpl_vars['templets']->directory; ?>
/images/banner4.jpg" alt="祛斑专家许老师尊荣"></li>
		<li><img src="<?php echo $this->_tpl_vars['siteurl']; ?>
/templets/<?php echo $this->_tpl_vars['templets']->directory; ?>
...
<div id="conner">
	<img src="<?php echo $this->_tpl_vars['siteurl']; ?>
/templets/<?php echo $this->_tpl_vars['templets']->directory; ?>
/images/conner_3.jpg" alt="测试者纷纷都说好">
	<img src="<?php echo $this->_tpl_vars['siteurl']; ?>
/templets/<?php echo $this->_tpl_vars['templets']->directory; ?>
...
/images/conner_220.jpg" alt="祛斑方法大对比">
	<img src="<?php echo $this->_tpl_vars['siteurl']; ?>
/templets/<?php echo $this->_tpl_vars['templets']->directory; ?>
/images/conner_221.jpg" alt="跟专家许老师看看那些祛斑方法要不得的">
	<img src="<?php echo $this->_tpl_vars['siteurl']; ?>
/templets/<?php echo $this->_tpl_vars['templets']->directory; ?>
...
<div id="photo">
	<img src="<?php echo $this->_tpl_vars['siteurl']; ?>
/templets/<?php echo $this->_tpl_vars['templets']->directory; ?>
/images/conner_6.jpg" alt="许老师部分学员风采">
	<img src="<?php echo $this->_tpl_vars['siteurl']; ?>
/templets/<?php echo $this->_tpl_vars['templets']->directory; ?>
/images/conner_200.jpg" alt="学员指导学员进行中">
	<img src="<?php echo $this->_tpl_vars['siteurl']; ?>
/templets/<?php echo $this->_tpl_vars['templets']->directory; ?>
/images/conner_7.jpg" alt="各省各地来学习斑道夫祛斑">
	<img src="<?php echo $this->_tpl_vars['siteurl']; ?>
/templets/<?php echo $this->_tpl_vars['templets']->directory; ?>
...
" >
			...
			<?php endif; ?>
			</a><span><?php echo ((is_array($_tmp=$this->_tpl_vars['newsinfo']->adddate)) ? $this->_run_mod_handler('date_format', true, $_tmp, '%Y-%m-%d') : smarty_modifier_date_format($_tmp, '%Y-%m-%d')); ?>
</span></li>
